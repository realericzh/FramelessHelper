#ifndef CXQUICKFRAMELESSHELPER_H
#define CXQUICKFRAMELESSHELPER_H

#include <QQuickItem>
#include <QQmlParserStatus>

class CxQuickFramelessHelperPrivate;
class CxQuickFramelessHelper : public QObject, public QQmlParserStatus
{
    Q_OBJECT
    Q_DECLARE_PRIVATE(CxQuickFramelessHelper)
...
public:
    explicit CxQuickFramelessHelper(QObject *parent = nullptr);
    virtual ~CxQuickFramelessHelper();
...
protected:
    QScopedPointer<CxQuickFramelessHelperPrivate> d_ptr;
};

#endif // CXQUICKFRAMELESSHELPER_H
